...
\begin{itemize}
    \item A Rubik's Cube is a 3x3x3 set of 26 "cubies", the small constituent cubes on the face of the object. The cubies can pivot about the centre of the cube, and the faces can be manipulated by rotation.

\begin{figure}[!h]
\begin{small}
\centering
\linespread{1.0}
\includegraphics[width=0.35\linewidth]{images/800px-Scrumbled_Rubik's_Cube.jpg}
...
\centering
\linespread{1.0}
\includegraphics[width=0.75\linewidth]{images/genetic algorithm.PNG}
...
\centering
\linespread{1.0}
\includegraphics[width=0.75\linewidth]{images/simulated annealing.PNG}
%\caption{Over several generations an individual that best satisfies the fitness criteria emerges. In our case, that means minimising a cost function.}
\label{fig:fig11}
\end{small}
\end{figure}
...
\centering
\linespread{1.0}
\includegraphics[width=0.75\linewidth]{images/pict1_graph.C.png}
%\caption{Over several generations an individual that best satisfies the fitness criteria emerges. In our case, that means minimising a cost function.}
\label{fig:fig11}
\end{small}
\end{figure}
