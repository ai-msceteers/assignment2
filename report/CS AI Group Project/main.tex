\documentclass{libraries/svproc}
%\usepackage{biblatex}
\usepackage[
backend=biber,
style=numeric,
...
\author{William O'Sullivan, Basil Contovounesios, Talha Ijaz,  Fionnt\'an \'O Suibhne}

\institute{
\email {wosulliv@tcd.ie},  {contovob@tcd.ie}, {ijazm@tcd.ie}, {suibhnef@tcd.ie}}
...
\centering
\linespread{1.0}
\includegraphics[width=0.75\linewidth]{images/move_3u.PNG}
...
\begin{itemize}
    \item n=3 mean runtime: 15 seconds %(lol)
    %\item n=3 mean no. of moves:
    \item n=2 mean runtime:
    %\item n=2 mean no. of moves:
\end{itemize}
