...
class RubiksCube(object):
    ...
    #/ Funtion evaluates cost based on rows (+3/row), columns (+3/row), and completed face (+3)
    #/ Rewards based on matched column or row, full stop regardless of face, it is atomatically benificial
    #/ to match faces so no need to evaluate based on column on correct side 
    #def calculate_cost_v2(self):
    #    total_cost = 0
    #    for i in range(6):
            #basically for a face, check all rows for matching colours
